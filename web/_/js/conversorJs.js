...
// 	nameSpaceCgi.transformarNubePtos = function (idFalla,urlBase){
// 			var url_nube = urlBase+"index.php/obtenerDatosVisualizacion/"+idFalla;
// 			debug("Ruta de la peticion cgi -->");
// 			debug(url_nube);
// 			$.ajax({
// 					url: url_nube,
// 					// url: "http://localhost/repoProyectoBacheo/web/index.php/obtenerDatosVisualizacion/"+idFalla,
...
// 		debug(json_estado.raiz_tmp);
// 		$.ajax({
// 			url:"generarDescripcion/"+idFalla+"/"+json_estado.raiz_tmp,
// 			success:function(data,status,jqhxr){
...
// 				json_final["path_csv"] = json_info_csv.info_csv;
...
// 					type: 'danger'
// 		});
// 		$("#imagenThumb").attr("src","../web/_/img/res/errorInterno.png");
